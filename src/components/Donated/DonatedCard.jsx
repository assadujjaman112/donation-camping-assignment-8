  ...
  return (
    <div>
      <div
        ...
        className="relative flex h-[250px] w-full max-w-[48rem] flex-row rounded-xl bg-clip-border shadow-md"
      >
        ...
        <div className="p-6">
          <p
            ...
            className="mb-4 py-1 w-1/3 text-center rounded-lg block  font-normal text-sm "
          >
            {category}
          </p>
